...
export async function POST(request: NextRequest) {
  try {
    ...
    // We need to clone the request to read body without consuming it
    ...
    try {
      ...
      // Not JSON or empty body, continue with database setup
    }
    
    if (body && (body.action === 'create-admin' || (body.email && body.password))) {
